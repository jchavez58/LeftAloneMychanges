...
void init() 
{
    ...
    gl.button[gl.nbuttons].r.height = 100;
    gl.button[gl.nbuttons].r.left = 1200;
    gl.button[gl.nbuttons].r.bot = 350;
    ...
    strcpy(gl.button[gl.nbuttons].text, "Reset");
    ...
    gl.button[gl.nbuttons].r.height = 100;
    gl.button[gl.nbuttons].r.left = 1200;
    gl.button[gl.nbuttons].r.bot = 200;
    gl.button[gl.nbuttons].r.right =
        gl.button[gl.nbuttons].r.left + gl.button[gl.nbuttons].r.width;
    gl.button[gl.nbuttons].r.top =
        gl.button[gl.nbuttons].r.bot + gl.button[gl.nbuttons].r.height;
    ...
    strcpy(gl.button[gl.nbuttons].text, "Quit");
    gl.button[gl.nbuttons].down = 0;
    gl.button[gl.nbuttons].click = 0;
...
void init_opengl(void)
{
    ...
    //texture for titlescreen picture
    glGenTextures(1, &gl.titlescreenTexture);
    glBindTexture(GL_TEXTURE_2D, gl.titlescreenTexture);
    glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_MAG_FILTER,GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_MIN_FILTER,GL_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, 3, img[7].width, img[7].height, 0,GL_RGB, GL_UNSIGNED_BYTE, img[7].data);
    
    //texture for startbutton
    glGenTextures(1, &gl.startbuttonTexture);
    glBindTexture(GL_TEXTURE_2D, gl.startbuttonTexture);
    glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_MAG_FILTER,GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D,GL_TEXTURE_MIN_FILTER,GL_NEAREST);
...
void render()
{
    ...
    */
        ...
        //glBindTexture(GL_TEXTURE_2D, gl.marbleTexture);
        glBegin(GL_QUADS);
        glTexCoord2f(0.0f, 0.0f); glVertex2i(0,      0);
        glTexCoord2f(0.0f, 1.0f); glVertex2i(0,      gl.yres);
        glTexCoord2f(1.0f, 1.0f); glVertex2i(gl.xres, gl.yres);
        glTexCoord2f(1.0f, 0.0f); glVertex2i(gl.xres, 0);
        glEnd();
    ...
    glBindTexture(GL_TEXTURE_2D, gl.startbuttonTexture);
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 1.0f); glVertex2i( );
    glTexCoord2f(0.0f, 0.0f); glVertex2i( );
    glTexCoord2f(1.0f, 0.0f); glVertex2i();
    glTexCoord2f(1.0f, 1.0f); glVertex2i();
    glEnd();
 */
        //draw all buttons added
